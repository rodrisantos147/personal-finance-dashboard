...
export function shouldReclassifyIncomeAsCardExpense(t: {
  ...
  return (
    /DLO\*|DLO\s*\*|PEDIDOSYA|PEDIDOS\s*YA|RAPPI|UBER\s*\*?|STM\b|SINERGIA|TU\s+RACION|RACION\b|SPOTIFY|CLAUDE|UTE\b|SODIMAC|TIENDAMIA|BAMBOO|MERPAGO|MP\s*\*|NETFLIX|HBO|PRIME|APPLE\.COM|GOOGLE\s*\*|OPENAI|\*OPENAI|OPENAI\*|CHATGPT|REPLIT|CURSOR|CLOUDFLARE|SUBSCRIPTION|\bTATA\b|\bBDB\b|\bZARA\b|\bMOVISTAR\b|\bANTEL\b|\bCLARO\b/i.test(
      u,
