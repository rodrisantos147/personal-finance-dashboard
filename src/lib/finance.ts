...
export function shouldReclassifyIncomeAsCardExpense(t: {
  ...
  return (
    /DLO\*|DLO\s*\*|PEDIDOSYA|PEDIDOS\s*YA|RAPPI|UBER\s*\*?|STM\b|SINERGIA|TU\s+RACION|RACION\b|SPOTIFY|CLAUDE|UTE\b|SODIMAC|TIENDAMIA|BAMBOO|MERPAGO|MP\s*\*|NETFLIX|HBO|PRIME|APPLE\.COM|GOOGLE\s*\*|OPENAI|SUBSCRIPTION|\bTATA\b|\bBDB\b|\bZARA\b/i.test(
      u,
